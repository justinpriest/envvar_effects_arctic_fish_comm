...
#ggsave(here::here("plotexports/Fig_envvar.png"), dpi = 300, width = 7.5, height = 5)
...
spprichplots
#ggsave(here::here("plotexports/Fig_spprichness2plot.png"), plot = spprichplots,  width = 6, height = 4, units = "in")
