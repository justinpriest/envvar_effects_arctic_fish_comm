...
spp_richness.wk <- spp_richness.wk %>% 
  left_join(effort.wk %>% dplyr::select(Year, week, sample_proportion), 
            by = c("Year" = "Year", "week" = "week", "sample_proportion" = "sample_proportion")) 
